...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <title>{{ config('app.name', 'Online Class Manager') }}</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-close">
            <router-link to="/admin/course" class="nav-link ">
              <i class="nav-icon fas fa-book cyan"></i>
              <p>
                Courses
              </p>
            </router-link>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-snowboarding blue"></i> 
               <p>
                 Activity Stream 
              </p>
            </a>
           ...
           <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-envelope-open-text yellow"></i>
              <p>
               Messages 
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-retweet indigo"></i>
              <p>
               Referrals  
              </p>
            </a>
